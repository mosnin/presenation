# Doc-Engine Design — documents in the template's aesthetic
...
Scope limits: single-column A4, one cover style, no images/charts, DOCX is
coarser than the PDF (Word styles, not CSS).
